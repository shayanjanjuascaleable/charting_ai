...
# Your API key is now hardcoded for testing purposes.
...
if not GEMINI_API_KEY:
    raise ValueError(
        "ERROR: Gemini API key is not set. Please provide a valid key."
    )
...
SERVER = os.environ.get('DB_SERVER', 'aiserverscaleable.database.windows.net')
DATABASE = os.environ.get('DB_DATABASE', 'Charting_Dataset_DB')
# Correctly set USERNAME and PASSWORD for Microsoft Entra Password authentication
USERNAME = os.environ.get('DB_USERNAME', 'saria@scaleablesolutions.com')
PASSWORD = os.environ.get('DB_PASSWORD', 'Zeshan#786')
...
def get_db_connection():
    ...
    try:
        conn_str = (
            ...
            # ADDING THIS LINE IS CRUCIAL FOR YOUR AUTHENTICATION METHOD
